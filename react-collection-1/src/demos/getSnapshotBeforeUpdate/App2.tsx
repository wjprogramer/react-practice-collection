...
const useGetSnapshotBeforeUpdate = (cb: any, props: any, state: any) => {
...
const App2 = (props: any) => {
  const chatThreadRef = useRef<any>()
  ...
  useComponentDidUpdate((prevProps: any, prevState: any, snapshot: any) => {
